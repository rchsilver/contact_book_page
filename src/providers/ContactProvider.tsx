...
import { TContact, TContactRquest } from "../interfaces/ContactTypes";
...
type TContextValue = {
  createContact: (data: TContactRquest) => Promise<void>;
...
const ContactProviders = ({ children }: TContactProvidersProps) => {
  ...
  const createContact = async (data: TContactRquest) => {
    try {
